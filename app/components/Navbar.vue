...
<template>
    <header class="site-nav" :class="{ 'site-nav--open': isMenuOpen }">
        <div class="site-nav__container">
            <NuxtLink to="/" class="site-nav__logo" @click="closeMenu">
                <span class="site-nav__logo-icon">✓</span>
                <span class="site-nav__logo-text">TaskFlow</span>
            </NuxtLink>

            <nav class="site-nav__menu">
                <NuxtLink to="/" class="site-nav__link" @click="closeMenu">Home</NuxtLink>
                <NuxtLink to="/todos" class="site-nav__link" @click="closeMenu">Todo's</NuxtLink>
                <NuxtLink to="/add" class="site-nav__link site-nav__link--cta" @click="closeMenu">Add Todo
                </NuxtLink>
            </nav>
