...
<template>
    <div class="todos-page">
        <div class="todos-page__header">
            ...
            <router-link to="/add" class="todos-page__add-btn">+ Add New</router-link>
        </div>

        <div v-if="error" class="error-banner">{{ error }}</div>


        <div v-else-if="todos.length === 0 && !error" class="todos-page__empty">
        ...
        <ul v-else class="todos-page__list">
            <li v-for="todo in todos" :key="todo.id" class="todos-page__item"
                ...
                <div class="todos-page__item-actions">
                    <router-link :to="`/todos/${todo.id}/edit`" class="btn-icon btn-icon--edit">
                        Edit
                    </router-link>
