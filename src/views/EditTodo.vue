...
const router = useRouter(); //this is to navigate 

const route = useRoute(); //this is to scann the url and extract data
...
const handleSubmit = async () => {
    ...
    try {
        ...
        router.push('/todos'); //we are navigating to the todos page
